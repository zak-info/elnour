  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">El Nour School Management System is built with Tailwindcss and Nextjs.</p>
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">This system is ready to use and you can totally customize as per your school's requirements.</p>
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">For customization, you should have knowledge of NextJs, ReactJs, Tailwind and JSX to be able to modify this system.</p>
        </div>
